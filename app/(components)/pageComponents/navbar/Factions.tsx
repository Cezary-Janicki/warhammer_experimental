  ...
  return (
    <>
      {Object.keys(factions).map((factionKeys: any, index) => {
        ...
        return (
          <div
            className="dropdown inline-block relative mr-4"
            key={factionKeys}
          >
            ...
            <ul className="dropdown-content absolute hidden border-4 border-neutral-400 divide-y divide-neutral-300 text-gray-700">
              {factionArmies.map((faction: any, index2: number) => {
                return (
                  <li className="dropdown" key={faction.faction_id}>
                    <p className="bg-neutral-200  hover:bg-gray-400 py-2 px-4 block">
